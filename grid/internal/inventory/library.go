...
func LibraryFolders() []Folder {
	return []Folder{
		...
		{ID: LibraryTexturesID, OwnerUserID: LibraryOwnerID, ParentID: LibraryRootID,
			Name: "Textures", TypeDefault: 0, Version: 3},
...
func LibraryItems() []Item {
	...
	return []Item{
		...
		{ID: "00000000-0000-4000-8000-000000000024", OwnerUserID: LibraryOwnerID,
			...
			CurrentPermissions: fullPermissions, EveryonePermissions: fullPermissions, NextPermissions: fullPermissions},
		{ID: "00000000-0000-4000-8000-000000000025", OwnerUserID: LibraryOwnerID,
			CreatorUserID: LibraryOwnerID, FolderID: LibraryTexturesID,
			AssetID: "5748decc-f629-461c-9a36-a35a221fe21f", AssetType: 0, InventoryType: 0,
			Name: "Blank", Description: "Standard blank white texture", BasePermissions: fullPermissions,
			CurrentPermissions: fullPermissions, EveryonePermissions: fullPermissions, NextPermissions: fullPermissions},
		{ID: "00000000-0000-4000-8000-000000000026", OwnerUserID: LibraryOwnerID,
			CreatorUserID: LibraryOwnerID, FolderID: LibraryTexturesID,
			AssetID: "89556747-24cb-43ed-920b-47caed15465f", AssetType: 0, InventoryType: 0,
			Name: "Plywood", Description: "Standard default plywood texture", BasePermissions: fullPermissions,
			CurrentPermissions: fullPermissions, EveryonePermissions: fullPermissions, NextPermissions: fullPermissions},
		{ID: "00000000-0000-4000-8000-000000000027", OwnerUserID: LibraryOwnerID,
			CreatorUserID: LibraryOwnerID, FolderID: LibraryTexturesID,
			AssetID: "8dcd4a48-2d37-4909-9f78-f7a9eb4ef903", AssetType: 0, InventoryType: 0,
			Name: "Transparent", Description: "Standard fully transparent texture", BasePermissions: fullPermissions,
			CurrentPermissions: fullPermissions, EveryonePermissions: fullPermissions, NextPermissions: fullPermissions},
		{ID: "00000000-0000-4000-8000-000000000028", OwnerUserID: LibraryOwnerID,
			CreatorUserID: LibraryOwnerID, FolderID: LibraryTexturesID,
			AssetID: "8b5fec65-8d8d-9dc5-cda8-8fdf2716e361", AssetType: 0, InventoryType: 0,
			Name: "Media", Description: "Standard media-on-a-prim placeholder texture", BasePermissions: fullPermissions,
			CurrentPermissions: fullPermissions, EveryonePermissions: fullPermissions, NextPermissions: fullPermissions},
