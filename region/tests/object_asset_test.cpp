...
int main() {
    const std::string json = R"({"format":"homeworldz-object-v1","creatorId":"10000000-0000-4000-8000-000000000001","name":"Prim2","scale":[0.500000,0.500000,0.500000],"rotation":[0.000000,0.000000,0.382683],"description":"","material":3,"basePermissions":647168})";
    ...
    if (!asset || asset->scale.x != 0.5 || asset->rotation.z != 0.382683 || asset->material != 3)
        return 1;
    const std::string invalid = R"({"format":"homeworldz-object-v1","scale":[0,1,1],"rotation":[0,0,0],"material":3})";
