...
int main() {
    const std::string json = R"({"format":"homeworldz-object-v1","creatorId":"10000000-0000-4000-8000-000000000001","name":"Sphere","scale":[0.500000,0.500000,0.500000],"rotation":[0.000000,0.000000,0.382683],"description":"Round \"prim\"","material":3,"physicsShapeType":2,"physicsDensity":125.000000,"physicsFriction":0.700000,"physicsRestitution":0.250000,"physicsGravityMultiplier":1.500000,"textureEntry":"aabbcc","pathCurve":32,"profileCurve":5,"basePermissions":647168})";
    ...
    if (!asset || asset->scale.x != 0.5 || asset->rotation.z != 0.382683 ||
        ...
        asset->path_curve != 0x20 || asset->profile_curve != 0x05 ||
