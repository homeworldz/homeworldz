...
`library/textures/` contains the canonical Blank and Plywood texture assets
expected by Second Life-compatible viewers and scripts. They retain their
standard viewer UUIDs. Library inventory records attribute their import to the
`HomeWorldz Library` service identity, independently of their upstream artwork
provenance.
